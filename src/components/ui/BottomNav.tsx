    ...
    <nav className="fixed bottom-0 w-full bg-background/80 backdrop-blur-xl border-t border-border z-50">
      <div className="flex justify-between items-center max-w-md mx-auto px-6 pt-3 pb-[env(safe-area-inset-bottom)] relative pb-4">
        ...
        <div className="flex-1 flex justify-center">
          <Link
            href="/goals/new"
            className="w-[60px] h-[60px] rounded-2xl bg-primary text-primary-foreground shadow-[0_8px_25px_rgba(255,0,85,0.3)] flex items-center justify-center hover:scale-110 active:scale-95 transition-all -translate-y-6 border-4 border-background"
          >
