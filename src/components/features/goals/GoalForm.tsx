...
function NewTaskInput({
  ...
  const handleAdd = () => {
    ...
    onAdd({ title: title.trim(), type, frequency });
    setTitle("");
    setType("recurring");
    setFrequency("daily");
    setIsExpanded(false);
  ...
  return (
    <div className="bg-card border-2 rounded-3xl p-6 space-y-4" style={{ borderColor: `${color}30` }}>
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <button
            ...
            style={{ backgroundColor: type === "recurring" ? color : undefined }}
          >
            Recurring
          </button>
          <button
            ...
            style={{ backgroundColor: type === "one_time" ? color : undefined }}
          >
            One-time
          </button>
        </div>
          ...
          <div className="flex gap-2">
            {(["daily", "weekly", "specific_days"] as const).map((f) => (
              <button
                ...
                style={{ backgroundColor: frequency === f ? color : undefined }}
              >
